...
Build signed and notarized macOS assets after semantic-release in a conditional job, skip that job without blocking release notes when signing credentials are unavailable, and publish versioned updater files plus stable DMG and ZIP aliases.
