...
export class PeakMetricsStore {
  ...
  private get(modelId: string): Record<string, unknown> | null {
    const row = this.db
  ...
  private getSession(sessionId: string): Record<string, unknown> | null {
    const row = this.db
  ...
  private getBestSession(modelId: string): Record<string, unknown> | null {
    const row = this.db
      .query(
        `
