...
- [x] Inspect active controller route surface for stable integration gaps.
- [x] Add studio settings and provider CRUD route contract coverage.
- [x] Validate those routes are persisted in controller observability rows.
- [x] Validate controller route coverage slice.
- [x] Commit this slice.
...
- [ ] Add controller integration and e2e tests for all active controller flows. Initial integration smoke coverage exists for core route contracts, raw observability persistence, and studio settings/provider CRUD; full active-flow coverage remains.
