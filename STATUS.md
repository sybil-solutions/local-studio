...
- [x] Inspect comments in `frontend/src/components/dashboard/use-dashboard-recipes.ts`.
- [x] Remove self-evident running-recipe comment.
- [x] Validate frontend dashboard recipe comment cleanup slice.
- [x] Commit this slice.
