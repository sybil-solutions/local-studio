...
- [x] Inspect proxy stream close comments.
- [x] Remove redundant proxy stream close comments.
- [x] Validate proxy stream comment cleanup slice.
- [x] Commit this slice.
