...
const identityDir = path.join(distDir, "services", "agent-runtime", "src");
mkdirSync(identityDir, { recursive: true });
copyFileSync(
  path.join(packageDir, "src", "executable-identity.cjs"),
  path.join(identityDir, "executable-identity.cjs"),
);
