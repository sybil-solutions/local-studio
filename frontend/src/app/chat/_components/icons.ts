// CRITICAL
/**
 * Centralized icon exports for chat components
 * This consolidates all lucide-react icon imports into a single location
 * Import from here instead of lucide-react to reduce import verbosity
 */
...
export { File, type LucideIcon } from "lucide-react";
